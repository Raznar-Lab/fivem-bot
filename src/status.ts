...
import { IVMainConfig } from './typings/fivem';
import axios from 'axios';

let curInterval: NodeJS.Timeout | undefined;
export const updateInterval = (client: Client<true>, data: IVMainConfig) => {
    if (data.interval > 2) {
...
const start = (client: Client<true>, data: IVMainConfig) => {
